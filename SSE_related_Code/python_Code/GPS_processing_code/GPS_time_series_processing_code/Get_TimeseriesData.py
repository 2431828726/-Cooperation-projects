...
#（2）Convert the reference frame from ITRF to NOAM {2023.10.31-}
#（3）Integrate data and add a separator of 9999.0 to each station's time series.
...
if section == 5:
    ...
    sdir = '../GRACE+loading/seasonal/'  # Get the seasonal file in the local folder
    stype = 'as'
